...
namespace cxp.data.Repository
{
    public class PedidoDetalleRepository : IPedidoDetalleRepository
    {
        ...
        public async Task<bool> DeleteDetallePedidoAll(int id)
        {
            var db = dbConnection();
        ...
        public async Task<bool> DeletePedidoDetalle(int id, int iddetalle)
        {
            var db = dbConnection();
        ...
        public async Task<PedidoDetalle> GetPedidoDetalles(int id, int idDetalle)
        {
            var db = dbConnection();
        ...
        public async Task<PedidoDetalle> GetDetallePedido(int id)
        {
            var db = dbConnection();
        ...
        public async Task<IEnumerable<PedidoDetalle>> GetListaPedidoDetalle(int id)
        {
            var db = dbConnection();
